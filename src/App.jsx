  ...
  return (
    <div> 
      ...
      <main>
        ...
        <section id="ceo-profile" className="py-5 bg-dark text-white">
          <Container fluid>
            ...
            <Row className="align-items-center">
              ...
              <Col md={8}>
                <p>
                    에스디에이시스템에 방문해주신 여러분을 진심으로 환영합니다.<br/><br/>
                    급변하는 디지털 환경 속에서 기업의 정보 자산 보호는 그 어느 때보다 중요해졌습니다. 저희 에스디에이시스템은 다년간의 축적된 경험과 전문성을 바탕으로 고객 여러분의 비즈니스 연속성을 보장하고, 잠재적인 위협으로부터 가장 안전한 방패가 되어드리고자 합니다.<br/><br/>
                    최신 보안 위협에 대응하기 위한 지속적인 연구와 기술 개발에 투자하고 있으며, 이를 통해 얻어진 최상의 보안 솔루션과 서비스를 제공할 것을 약속드립니다.<br/><br/>
                    고객의 신뢰를 최우선으로 여기며, 항상 고객의 입장에서 생각하고 소통하는 든든한 파트너가 되겠습니다.<br/><br/>
                    감사합니다.
                </p>
              </Col>
            </Row>
